...
namespace KENCO_LOGISTIQUES_APP
{
    partial class Accounting
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ExpenseYearBox = new System.Windows.Forms.ComboBox();
            this.label5 = new System.Windows.Forms.Label();
            this.ExpenseMonthBox = new System.Windows.Forms.ComboBox();
            this.label4 = new System.Windows.Forms.Label();
            this.ExpenseDayBox = new System.Windows.Forms.ComboBox();
            this.IncomeAmountBox = new System.Windows.Forms.TextBox();
            this.label10 = new System.Windows.Forms.Label();
            this.IncomeDescription = new System.Windows.Forms.ComboBox();
            this.ExpenseDecriptionBox = new System.Windows.Forms.ComboBox();
            this.label6 = new System.Windows.Forms.Label();
            this.IncomeDateBox = new System.Windows.Forms.ComboBox();
            this.label11 = new System.Windows.Forms.Label();
            this.IncomeMonthBox = new System.Windows.Forms.ComboBox();
            this.label12 = new System.Windows.Forms.Label();
            this.IncomeYearBox = new System.Windows.Forms.ComboBox();
            ...
            this.panel1.Controls.Add(this.ExpenseYearBox);
            this.panel1.Controls.Add(this.label5);
            this.panel1.Controls.Add(this.ExpenseMonthBox);
            this.panel1.Controls.Add(this.label4);
            this.panel1.Controls.Add(this.ExpenseDayBox);
            this.panel1.Controls.Add(this.IncomeAmountBox);
            this.panel1.Controls.Add(this.label10);
            this.panel1.Controls.Add(this.IncomeDescription);
            this.panel1.Controls.Add(this.ExpenseDecriptionBox);
            this.panel1.Controls.Add(this.label6);
            this.panel1.Controls.Add(this.IncomeDateBox);
            this.panel1.Controls.Add(this.label11);
            this.panel1.Controls.Add(this.IncomeMonthBox);
            this.panel1.Controls.Add(this.label12);
            this.panel1.Controls.Add(this.IncomeYearBox);
            ...
            // ExpenseYearBox
            // 
            this.ExpenseYearBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.ExpenseYearBox.FormattingEnabled = true;
            this.ExpenseYearBox.Items.AddRange(new object[] {
            "1950",
            "1951",
            "1952",
            "1953",
            ...
            // ExpenseMonthBox
            // 
            this.ExpenseMonthBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.ExpenseMonthBox.FormattingEnabled = true;
            this.ExpenseMonthBox.Items.AddRange(new object[] {
            "01",
            "02",
            "03",
            "04",
            ...
            // ExpenseDayBox
            // 
            this.ExpenseDayBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.ExpenseDayBox.FormattingEnabled = true;
            this.ExpenseDayBox.Items.AddRange(new object[] {
            "01",
            "02",
            "03",
            "04",
            ...
            // IncomeDescription
            // 
            this.IncomeDescription.FormattingEnabled = true;
            this.IncomeDescription.Items.AddRange(new object[] {
            ...
            // 
            // ExpenseDecriptionBox
            // 
            this.ExpenseDecriptionBox.FormattingEnabled = true;
            this.ExpenseDecriptionBox.Items.AddRange(new object[] {
            "Fuel costs (diesel, gasoline)",
            "Vehicle maintenance and repairs",
            "Driver salaries and wages",
            "Insurance premiums (vehicle insurance, liability insurance)",
            "Vehicle lease or purchase payments",
            "Permits and licenses (e.g., DOT permits, registration fees)",
            "Toll fees and road taxes",
            "Dispatch and administrative expenses",
            "Fuel taxes and surcharges",
            "Vehicle depreciation",
            "Dispatch software and technology expenses",
            "Safety and compliance training costs",
            "Office rent or lease payments",
            "Utilities (electricity, water, internet)",
            "Fleet management software subscriptions",
            "Vehicle inspections and safety equipment (e.g., DOT inspections, safety cones)",
            "Communication expenses (cell phones, radios)",
            "Cargo insurance premiums",
            "Marketing and advertising expenses",
            "Taxes (income tax, property tax, sales tax)",
            "Legal and professional fees (lawyers, accountants)",
            "Employee benefits (health insurance, retirement plans)",
            "Vehicle lease or rental expenses",
            "Breakdown and emergency roadside assistance costs",
            "Vehicle washing and cleaning expenses",
            "Per diem and lodging expenses for drivers",
            ...
            // IncomeDateBox
            // 
            this.IncomeDateBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.IncomeDateBox.FormattingEnabled = true;
            this.IncomeDateBox.Items.AddRange(new object[] {
            "01",
            "02",
            "03",
            "04",
            ...
            // IncomeMonthBox
            // 
            this.IncomeMonthBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.IncomeMonthBox.FormattingEnabled = true;
            this.IncomeMonthBox.Items.AddRange(new object[] {
            "01",
            "02",
            "03",
            "04",
            ...
            // IncomeYearBox
            // 
            this.IncomeYearBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.IncomeYearBox.FormattingEnabled = true;
            this.IncomeYearBox.Items.AddRange(new object[] {
            "1950",
            "1951",
            "1952",
            "1953",
            ...
            this.panel2.Size = new System.Drawing.Size(1580, 209);
            ...
            this.Column8,
            this.Column9});
            this.dataGridView3.Location = new System.Drawing.Point(22, 32);
            ...
            this.label13.Font = new System.Drawing.Font("Showcard Gothic", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point);
            this.label13.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
            this.label13.Location = new System.Drawing.Point(722, 11);
            this.label13.Name = "label13";
            this.label13.Size = new System.Drawing.Size(97, 18);
            this.label13.TabIndex = 246;
            this.label13.Text = "CashFlow";
            // 
            // Reset
            // 
            ...
            this.AddNew.TabIndex = 247;
            this.AddNew.Text = "Calculate";
        ...
        private TextBox ExpenseAmountBox;
        private Label label8;
        private Label label2;
        private Label label9;
        private Label label3;
        private ComboBox ExpenseYearBox;
        private Label label5;
        private ComboBox ExpenseMonthBox;
        private Label label4;
        private ComboBox ExpenseDayBox;
        private TextBox IncomeAmountBox;
        private Label label10;
        private ComboBox IncomeDescription;
        private ComboBox ExpenseDecriptionBox;
        private Label label6;
        private ComboBox IncomeDateBox;
        private Label label11;
        private ComboBox IncomeMonthBox;
        private Label label12;
        private ComboBox IncomeYearBox;
